...
public:
    ...
    void setLastMidName(std::string last_mid_name) { this->last_mid_name = last_mid_name; };
    ...
    void setBirthPlace(std::string birth_place) { this->birth_place = birth_place; };
    void setEmail(std::string email) { this->email = email; };
    void setPhoneNum(std::string phone_num) { this->phone_num = phone_num; };
